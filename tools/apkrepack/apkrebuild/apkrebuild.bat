...
if not exist %4 goto KEY_FAILED
...
jarsigner -verbose -keystore %3 -storepass %4 -keypass %4 -digestalg SHA1 -sigalg MD5withRSA -signedjar gen\game_signed.apk gen\game_unsigned.apk %5
